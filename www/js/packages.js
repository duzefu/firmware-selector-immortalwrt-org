...
export const popularPackageCategories = [
  ...
  },
  {
    ...
    packages: [
      { name: "luci-proto-wireguard", label: "WireGuard" },
      { name: "luci-app-openvpn", label: "OpenVPN" },
  ...
  },
  {
    ...
    packages: [
      ...
      { name: "luci-app-openlist", label: "OpenList" },
  ...
  },
  {
    ...
    packages: [
      ...
      { name: "luci-app-advanced-reboot", label: "Advanced Reboot" },
